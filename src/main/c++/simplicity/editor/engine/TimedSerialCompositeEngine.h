 ...
 */
#ifndef TIMEDSERIALCOMPOSITEENGINE_H_
#define TIMEDSERIALCOMPOSITEENGINE_H_
...
namespace simplicity
{
	 ...
	 *
	 * <p>
	 * Provides information about the running times of the contained engines.
	 * </p>
	 */
	class SIMPLE_API TimedSerialCompositeEngine : public CompositeEngine
	{
		public:
			TimedSerialCompositeEngine();
...
#endif /* TIMEDSERIALCOMPOSITEENGINE_H_ */
